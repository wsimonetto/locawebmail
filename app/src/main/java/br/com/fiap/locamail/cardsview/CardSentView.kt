...
fun CardSentView (
    ...
    val listaEmailState =
        remember { mutableStateOf(emailRepository.listarEmailsNoEnviadoOrdenadosPorIdDecrescente()) }
    var ckeckboxVisible by remember { mutableStateOf(false) } // Estado para controlar a visibilidade do RadioButton
    ...
    Box(
        ...
        Column(
                        ...
                        if (!ckeckboxVisible) {
                            ...
                            IconButton(
                                modifier = Modifier
                                    .padding(end = 14.dp),
                                onClick = {
                                    ckeckboxVisible = !ckeckboxVisible
            ...
            EmailList(
                ...
                checkboxVisible = ckeckboxVisible,
                ...
                currentView = EmailView.INBOX_SENT,
            ...
            Row(
                ...
                IconButton(
                    onClick = {
                        ...
                        listaEmailState.value = emailRepository.listarEmailsCaixaEntrada()
                        ckeckboxVisible = false
                        EmailSelectionManager.setSelection(false)
                    },
                ) {
                    Icon(
                        ...
                        modifier = Modifier
                            .size(35.dp),
                        tint = if (ckeckboxVisible) colorResource(id = R.color.vermelho_escuro) else colorResource(id = R.color.cinza)
                    )
                }
            }
        }
